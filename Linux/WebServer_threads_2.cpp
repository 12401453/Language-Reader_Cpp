...
#include <sstream>
#include "WebServer_threads.h"
#include <math.h>
#include <sys/stat.h>
#include <vector>

void WebServer::onMessageReceived(int clientSocket, const char *msg, int length, int get_or_post, int headers_length, int content_length) {
...
void WebServer::handlePOSTedData(const char* post_data, int clientSocket, const char* url) {
